...
output "private_subnet_arns" {
  ...
  value       = module.vpc_test.private_subnet_arns
}
...
output "public_subnet_arns" {
  ...
  value       = module.vpc_test.public_subnet_arns
}
...
output "database_subnet_arns" {
  ...
  value       = module.vpc_test.database_subnet_arns
}

output "database_subnets_cidr_blocks" {
  description = "List of cidr_blocks of database subnets"
  value       = module.vpc_test.database_subnets_cidr_blocks
}
...
output "vpc_secondary_cidr_blocks" {
  ...
  value       = module.vpc_test.vpc_secondary_cidr_blocks
}
